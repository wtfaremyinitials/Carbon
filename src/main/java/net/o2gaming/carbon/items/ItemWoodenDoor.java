...
public class ItemWoodenDoor extends ItemDoor {
  ...
  public boolean interactWith(ItemStack paramItemStack, EntityHuman paramEntityHuman, World paramWorld, int paramInt1, int paramInt2, int paramInt3, int paramInt4, float paramFloat1, float paramFloat2, float paramFloat3) {
    ...
    switch(type) {
        case SPRUCE:
            localBlock = Carbon.instance.getInjector().spruceDoorBlock;
            break;
        case BIRCH:
            localBlock = Carbon.instance.getInjector().birchDoorBlock;
            break;
        case JUNGLE:
            localBlock = Carbon.instance.getInjector().jungleDoorBlock;
            break;
        case ACACIA:
            localBlock = Carbon.instance.getInjector().acaciaDoorBlock;
            break;
        case DARK_OAK:
            localBlock = Carbon.instance.getInjector().darkOakDoorBlock;
            break;
        default:
